...
$birimler = fetch_all("SELECT bi.id, bi.ad, bi.qr_kod, k.ad kat_ad, b.ad bina_ad
 FROM birimler bi
 LEFT JOIN katlar k ON k.id=bi.kat_id
 LEFT JOIN binalar b ON b.id=k.bina_id
 ORDER BY b.ad, k.ad, bi.ad");
    ...
    <div class="list" id="screenList">
      ...
      <div class="qr-item"
        ...
        <div class="center-zone">
          ...
          <div class="helper">Bu birim ile ilgili şikayet / temizlik kaydı için QR kodu okutunuz.</div>
        </div>
  ...
  function buildPrint(){
    ...
    items.forEach(item=>{
      if(count % 2 === 0){
        ...
        sheet.innerHTML=''; // pair container yerine direkt esnek alt alta
      ...
      block.innerHTML=`
        ...
        <div class="print-center">
          ...
          <div class="print-helper">Bu birim ile ilgili şikayet / temizlik kaydı için QR kodu okutunuz.</div>
        </div>
